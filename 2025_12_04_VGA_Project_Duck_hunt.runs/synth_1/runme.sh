...
HD_PWD='D:/working/systemverilog/2025_12_04_VGA_Project_Duck_hunt/2025_12_04_VGA_Project_Duck_hunt.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DuckHunt_System.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DuckHunt_System.tcl
