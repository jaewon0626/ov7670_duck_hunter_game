...
HD_PWD='D:/working/systemverilog/2025_12_04_VGA_Project_Duck_hunt/2025_12_04_VGA_Project_Duck_hunt.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DuckHunt_System.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DuckHunt_System.tcl -notrace
